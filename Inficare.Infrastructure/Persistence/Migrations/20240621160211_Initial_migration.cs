        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetRoles_AspNetRoles_ParentRefId",
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName", "ParentRefId" },
                values: new object[] { 1, "647808af-878a-41e5-9d69-5796165214bd", "Super Agent", "SUPER AGENT", null });

            migrationBuilder.InsertData(
                table: "Profiles",
                columns: new[] { "Id", "DateOfBirth", "FirstName", "IsActive", "LastName", "LastUpdatedAt", "LastUpdatedBy", "MiddleName", "Suffix" },
                values: new object[] { 1, null, "Super", true, "Agent", new DateTimeOffset(new DateTime(2023, 2, 28, 10, 10, 58, 959, DateTimeKind.Unspecified).AddTicks(6954), new TimeSpan(0, 0, 0, 0, 0)), "SA", null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, "b91d74d8-5516-4cfb-b7e5-02d3885cb2bd", 0, "prafullashrestha8@gmail.com", true, true, new DateTimeOffset(new DateTime(2023, 2, 28, 10, 10, 58, 959, DateTimeKind.Unspecified).AddTicks(6954), new TimeSpan(0, 0, 0, 0, 0)), "SA", true, null, "PRAFULLASHRESTHA8@GMAIL.COM", "PRAFULLASHRESTHA8@GMAIL.COM", null, null, false, "851536ae-aded-4c9d-b342-738d0fb066eb", false, "prafullashrestha8@gmail.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_ParentRefId",
                table: "AspNetRoles",
                column: "ParentRefId");

...
namespace Inficare.Infrastructure.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<int> CreateAgentAsync(UserProfile userProfile,string password, string email, string clientUrl, CancellationToken cancellationToken)
        {
            var dbUser = new User
            {
                UserName = email,
                ...
                Roles = new List<UserRole> { new UserRole { RoleId = RoleInitializer.SUPER_AGENT } },
                ProfileRef = userProfile,
                EventActivity = UserEventActivity.Invite,
                Link = clientUrl,
                RoleName = RoleInitializer.SUPER_AGENT_NAME,
